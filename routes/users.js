...
router.post('/register', function(req, res){
	...
	req.checkBody('password2', 'Passwords are incompatable').equals(req.body.password);
	...
	if(errors){
		...
		req.flash('success_msg', 'You signed up successfully you can now login');
...
router.get('/logout',function(req,res){
    ...
    req.flash('success_msg','logged out bye byee');
    res.redirect('/users/login')
});
